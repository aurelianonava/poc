# Day 3 - The Vue Instance: Data Driven Applications
...
I\> For a more detailed explanation of data reactivity - be sure to read through the [Reactivity in Depth][1] section of the core Vue documentation.

For those who may be coming from a [React][2] background, you might notice reactive state (i.e. data) is different to how data is handled in React. In React, [state should often be treated as _immutable_][3]. Reactive state is one of the key differences that make Vue unique. State (i.e. data) management is often intuitive and easy to understand since modifying state directly causes the view to update.
...
> Live version - [https://30dofv-simpledatachange.surge.sh][4]
...
I\> If you've used [React][5], [Angular][6], or other modern-day front end frameworks/libraries; you might be used to a similar pattern on how modifying data/state _drives the changes in an application UI_.
...
I\> Vue 3.0, which is expected to launch sometime in 2019, will use a [Proxy-based observation mechanism][7] to detect data changes. This would allow us to delete or add new properties after an instance has already been initialized! We take a deep dive to the updates Vue 3.0 will bring in the second last article of the series - **Vue 3.0 and the future of Vue**.

For more information on reactivity in Vue and declaring reactive properties upfront, be sure to check out the [Reactivity in Depth][8] section of the Vue documentation.

That's it for today! In the next article, we’ll begin the discussion on some important and very useful Vue directives.

[1]:	https://vuejs.org/v2/guide/reactivity.html
[2]:	https://reactjs.org/
[3]:	https://reactjs.org/docs/react-component.html#state
[4]:	https://30dofv-simpledatachange.surge.sh
[5]:	https://reactjs.org
[6]:	https://angular.io/
[7]:	https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Proxy
[8]:	https://vuejs.org/v2/guide/reactivity.html